<template>
  <q-page class="bg-dark text-white q-pa-xl">
    <div class="flex items-end q-mb-xl">
      <!-- Copertina album -->
      <q-img :src="artist?.albumCover" width="280px" ratio="1" class="rounded-borders shadow-4" />
...
onMounted(async () => {
  await useSong.loadArtistData() // recupera dati da artist.json e copertina da iTunes
})
